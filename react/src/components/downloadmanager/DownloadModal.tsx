...
const DownloadModal = ({status, downloadUrl, isModalOpen, handleModalClose}: DownloadModalProps) => {
  return (
          ...
          >
          <DialogTitle sx={{textAlign: 'center'}}>{ status === 'created' ? 'Your report is ready' : `Your report is being created` }</DialogTitle>
